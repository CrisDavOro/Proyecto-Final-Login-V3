    ...
    <section class="login-seccion" id="seccion-login">
        <article class="registro-contenido">
            <div class="registro-contenido-izq">
                ...
                <!-- <div class="registro-izq-form"></div> -->
                    <div class="login-form-buttons">
                        <div class="login-form-button">
                            <input type="button" value="Cuenta Gratis" name="registro-boton" id="registro-boton" onclick="location.href='RegistroUsuarioGratis.php'"></button>
                        </div>
                    </div>

                    <div class="login-form-buttons">
                        <div class="login-form-button">
                            <input type="button" value="Cuenta Premium" name="registro-boton" id="registro-boton" onclick="location.href='RegistroUsuarioPago.php'"></button>
                        </div>
                    </div> 
                <!-- </div> -->
