<?php
    ...
    if(isset($_POST["boton-ingresar"])){
        ...
        if(!empty($_POST['nombre']) && !empty($_POST['password']) ){
            ...
            $query = mysqli_query($conexion, "SELECT * FROM usuarios1 WHERE nombre = '$nombre'");
            ...
            if(!$results){
                ...
                if(password_verify($password, $results['contrasenia'])){
                    ...
                    $_SESSION['idSesion'] = $results['id_usuario'];
                    $_SESSION['session_username'] = $nombre;
                    header('Location: ../../Proyecto-Final V1.1');
                }
                else {
    ...
    /* if(!empty($_POST['nombre']) && !empty($_POST['password']) ){
        $records = $conn->prepare('SELECT * FROM usuarios1 WHERE nombre = :nombre');
        ...
        if(is_array($results)){
            ...
            $message = 'Las credenciales no coinciden con un usuario registrado';
        }
    ...
    <section class="login-seccion" id="seccion-login">
        <article class="login-contenido">
            ...
            <div class="login-contenido-der">
                ...
                <!-- <form id="form-login" action="../login/InicioSesion.php" method="post" class="login-der-form"> -->
                ...
                <div class="login-der-enlaces">
                    ...
                    <a href="recuperarContraseña.html"><small>Recuperar Contraseña</small> </a>
                </div>
            </div>
        </article>
    </section>
